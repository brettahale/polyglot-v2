...
UserSchema.methods = {
  ...
  * @alias UserModel.addUser
  * @memberof module:models/user
  * @param {string} candidatePassword - Password attempting to authenticate with.
  * @param {string} hash - Password hash attempting to authenticate with.
  * @param {function} callback - Callback Passed into the Mongoose find method.
  */
